...
import com.teknesya.bimacampadmin.Adapter.AgentCustomerPlanAdapter;
...
public class AgentCustomerDetail extends AppCompatActivity {
    ...
    TextView dob, mariatl_status, anniversary, gender,
            total_family,totalPlan,pincode,state,landmark,area;
   ...
   // private final ArrayList<ItemLead> maturityRecyclearArrayList = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // mAuth = FirebaseAuth.getInstance();
        ...
        agentAuth = get.getStringExtra("agentAuth");

        mStorageRef = FirebaseStorage.getInstance().getReference();
        final StorageReference upload = mStorageRef.child("customer").child(agentAuth).child(nodeId);
...
//        maturityrecycle.setAdapter(maturityRecycleAdapter);
    ...
    public void updatePersonalDetail() {
        dRef = mRoot.child("users").child("agent").child(agentAuth)
                .child("customer");
