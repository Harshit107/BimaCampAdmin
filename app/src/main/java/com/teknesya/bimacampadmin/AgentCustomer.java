...
public class AgentCustomer extends AppCompatActivity implements CustomerRecyclerAdapter.OnLoadMoreListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAuth = get.getStringExtra("nodeId");
        ...
        try {  listingQuery.addChildEventListener(new ChildEventListener() {
                ...
                public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                    ...
                    if (dataSnapshot.getChildrenCount() > 0) {
                        ...
                        try {
//                            dataSnapshot = dataSnapshot.child("detail");
                            ...
                            String creationDate = dataSnapshot.child("detail").child("gender").getValue().toString();
                           // String type = dataSnapshot.child("detail").child("type").getValue().toString();
                            //Log.d("TAG",name+" "+type);
                            String image = "";
                            try {
